...
export const catalogThemes: CatalogTheme[] = [
  ...
  },
  {
    ...
    name: 'Одежда',
    icon: '👗',
    categories: ['Платья', 'Костюмы', 'Аксессуары', 'Верхняя одежда', 'Обувь', 'Блузы'],
    products: [
      {
        id: 101,
      ...
      {
        id: 111,
        name: 'Плащ "Монте-Карло"',
        brand: 'Burberry',
        category: 'Верхняя одежда',
        price: 165000,
        power: 'Размер M-L',
        voltage: 'Длина 110 см',
        weight: '1.1 кг',
        description: 'Классический тренч из водоотталкивающего габардина',
        image: 'https://cdn.poehali.dev/files/gettyimages-1347455404-1024x1024.jpg',
        inStock: true,
      },
      {
        ...
        weight: '0.6 кг',
        description: 'Классические лодочки из лакированной кожи',
        image: 'https://cdn.poehali.dev/files/gettyimages-2155004323-1024x1024.jpg',
        inStock: true,
      },
      {
        ...
        voltage: 'Шёлк 100%',
        weight: '0.2 кг',
        description: 'Шелковая блуза с бантом на воротнике',
        image: 'https://cdn.poehali.dev/files/gettyimages-1847199028-1024x1024.jpg',
        inStock: true,
      },
      {
        id: 114,
        name: 'Ремень "Классика"',
        brand: 'Hermès',
        category: 'Аксессуары',
        price: 52000,
        power: 'Длина 85-110 см',
        voltage: 'Кожа телёнка',
        weight: '0.15 кг',
        description: 'Двусторонний кожаный ремень с фирменной пряжкой',
        image: 'https://cdn.poehali.dev/files/gettyimages-1462655622-1024x1024.jpg',
        inStock: true,
      },
      {
        ...
        voltage: 'Шерсть 100%',
        weight: '1.5 кг',
        description: 'Вечерний смокинг с атласными лацканами',
        image: 'https://cdn.poehali.dev/files/gettyimages-495960336-1024x1024.jpg',
        inStock: false,
      },
    ],
